...
Route::patch('borrowing-requests/{request}/approve', [BorrowingRequestController::class, 'approve']);
Route::patch('borrowing-requests/{request}/reject', [BorrowingRequestController::class, 'reject']);
